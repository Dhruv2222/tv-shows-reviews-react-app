...
interface Show {
  ...
  const allShows: Show[] = [
    ...
    },
    {
      ...
      summary: "After a violent shipwreck, billionaire playboy Oliver Queen was missing and presumed dead for five years before being discovered alive on a remote island in the Pacific. He returned home to Starling City, welcomed by his devoted mother Moira, beloved sister Thea and former flame Laurel Lance.",
      avgRuntime: 60,
      status: 'Ended',
      language: "English",
      premiered: "2018-01-20",
    ...
    },
    {
      ...
      summary: "For young Sheldon Cooper, it isn't easy growing up in East Texas. Being a once-in-a-generation mind capable of advanced mathematics and science isn't always helpful in a land where church and football are king. And while the vulnerable, gifted and somewhat naïve Sheldon deals with the world, his very normal family must find a way to deal with him.",
      avgRuntime: 60,
      status: 'Ended',
      language: "English",
      premiered: "2018-01-20",
    ...
    },
    {
      ...
      summary: "The cases of the Naval Criminal Investigative Service's Washington, D.C. Major Case Response Team, led by Special Agent Leroy Jethro Gibbs.",
      avgRuntime: 60,
      status: 'Ended',
      language: "English",
      premiered: "2018-01-20",
    ...
    },
    {
      ...
      summary: "After surviving Godzilla's attack on San Francisco, Cate is shaken yet again by a shocking secret. Amid monstrous threats, she embarks on a globetrotting adventure to learn the truth about her family—and the mysterious organization known as Monarch.",
      avgRuntime: 60,
      status: 'Ended',
      language: "English",
      premiered: "2018-01-20",
    ...
    },
    {
      ...
      summary: "The Last Kingdom is a show of heroic deeds and epic battles but with a thematic depth that embraces politics, religion, warfare, courage, love, loyalty and our universal search for identity.",
      avgRuntime: 60,
      status: 'Ended',
      language: "English",
      premiered: "2018-01-20",
